...
WebUI.click(findTestObject('Page_Bitsane_Balances/Invoices_list/Invoices_tab'))

WebUI.delay(2)

WebUI.click(findTestObject('Page_Bitsane_Balances/Invoices_list/Show'))

WebUI.delay(2)

WebUI.click(findTestObject('Page_Bitsane_Balances/Invoices_list/print'))
