...
not_run: WebUI.navigateToUrl('https://wallet.btc.com/?_ga=2.73534870.548114136.1526374655-30268635.1526374655#/setup/login')
...
WebUI.setText(findTestObject('Page_Bitsane_Balances/Wallets/Withdrawal_address_BTC'), depositAddressBtc)

WebUI.verifyElementVisible(findTestObject('Page_Bitsane_Balances/Wallets/Withdrawal_amount_BTC'))

WebUI.verifyElementVisible(findTestObject('Page_Bitsane_Balances/Wallets/Withdrawal_address_BTC'))

WebUI.verifyElementVisible(findTestObject('Page_Bitsane_Balances/Wallets/Withdrawal_button_proceed_BTC'))
