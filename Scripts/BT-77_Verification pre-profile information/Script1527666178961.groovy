...
WebUI.verifyTextPresent('Kindly make sure you have filled in all of the below listed fields in the \'Personal information\' tab', 
    false)

WebUI.verifyTextPresent('After all the fields have been successfully filled in, upload buttons for verification will be available here.', 
    false)
